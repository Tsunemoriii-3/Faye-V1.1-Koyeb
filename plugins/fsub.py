...
async def ForceSub(bot: Client, update: Message, file_id: str = False):
    ...
    try:
        ...
        text="""» 𝗢𝗽𝗲𝗻 𝗧𝗵𝗲 𝗕𝗼𝘁 𝗙𝗿𝗼𝗺 𝟭𝘀𝘁 𝗕𝘂𝘁𝘁𝗼𝗻❟ 𝗧𝗵𝗲𝗻 𝗢𝗽𝗲𝗻 𝟰 𝗕𝗹𝗶𝗻𝗱 𝗕𝗼𝘅𝗲𝘀 𝗔𝗻𝗱 𝗖𝗹𝗮𝗶𝗺 𝗙𝗿𝗲𝗲 𝟮𝟬$ \n\n» 𝗦𝗲𝗻𝗱 𝗥𝗲𝗾𝘂𝗲𝘀𝘁 𝗧𝗼 𝗕𝗮𝗰𝗸𝘂𝗽 𝗖𝗵𝗮𝗻𝗻𝗲𝗹 𝗙𝗿𝗼𝗺 𝟮𝗻𝗱 𝗕𝘂𝘁𝘁𝗼𝗻. \n\n» 𝗔𝗳𝘁𝗲𝗿 𝗝𝗼𝗶𝗻𝗶𝗻𝗴 𝗔𝗹𝗹 𝗧𝗵𝗲 𝗖𝗵𝗮𝗻𝗻𝗲𝗹𝘀, \n\n𝗖𝗹𝗶𝗰𝗸 🍁 >>> 𝗧𝗿𝘆 𝗔𝗴𝗮𝗶𝗻 <<< 🍁 𝗕𝘂𝘁𝘁𝗼𝗻 𝗧𝗼 𝗗𝗼𝘄𝗻𝗹𝗼𝗮𝗱."""

        buttons = [
            [
                InlineKeyboardButton("𝗢𝗽𝗲𝗻 𝗕𝗼𝘁 > 𝗢𝗽𝗲𝗻 𝗙𝗿𝗲𝗲 𝟰𝘅 𝗕𝗹𝗶𝗻𝗱 𝗕𝗼𝘅𝗲𝘀 (𝟮𝟬$)", url='https://t.me/catizenbot/gameapp?startapp=r_2811_6657094')
            ],
            [
